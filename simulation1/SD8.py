...
def run_cv(seed):
    ...
    para_mix = {'batch_size': 100, 'momentum': 0.9, 'n_epochs': epoch,
                ...
                'L1_reg': 0.001, 'L2_reg': 0.0001, 'hidden_layers_sizes': [200]}
    ...
    para_super = {'batch_size': 100, 'momentum': 0.9, 'n_epochs': 200, 'tune_batch': 100,
                  'learning_rate': 0.2, 'lr_decay': 0.005, 'dropout': 0.5, 'tune_lr': 0.015, 'tune_epochs': 200,
                  'L1_reg': 0.001, 'L2_reg': 0.001, 'hidden_layers_sizes': [200]}

    Aggr, EA, Minor = get_data("EUR_AFR_0.54_h0.25.mat", seed=seed)
    Map = {}
