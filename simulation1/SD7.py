...
def run_cv(seed):
    ...
    para_mix = {'batch_size': 100, 'momentum': 0.9, 'n_epochs': epoch,
                'learning_rate': 0.2, 'lr_decay': 0.005, 'dropout': 0.5,
    ...
    para_naive = {'batch_size': 100, 'momentum': 0.9, 'n_epochs': epoch,
                  ...
                  'L1_reg': 0.0, 'L2_reg': 0.0001, 'hidden_layers_sizes': [200]}
    para_super = {'batch_size': 50, 'momentum': 0.9, 'n_epochs': epoch,
                  'learning_rate': 0.015, 'lr_decay': 0.0, 'dropout': 0.5,
                  'L1_reg': 0.0001, 'L2_reg': 0.0001, 'hidden_layers_sizes': [200]}

    Aggr, EA, Minor = get_data("EUR_EAS_0.58_h0.25.mat", seed=seed)
