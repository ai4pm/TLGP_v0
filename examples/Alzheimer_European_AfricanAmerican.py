...
def run_cv(seed):
    ...
    epoch = 100
    para_mix = {'batch_size': 32, 'momentum': 0.9, 'n_epochs': 100,
                'learning_rate': 0.01, 'lr_decay': 0.0, 'dropout': 0.5,
                'L1_reg': 0.0015, 'L2_reg': 0.0015, 'hidden_layers_sizes': [200]}
    para_ind_EA = {'batch_size': 32, 'momentum': 0.9, 'n_epochs': 50,
                'learning_rate': 0.01, 'lr_decay': 0.0, 'dropout': 0.5,
    ...
    para_super = {'batch_size': 50, 'momentum': 0.9, 'n_epochs': epoch, 'tune_batch': 50,
                  'learning_rate': 0.015, 'lr_decay': 0.003, 'dropout': 0.5, 'tune_lr': 0.015, 'tune_epochs': epoch,
                  'L1_reg': 0.001, 'L2_reg': 0.001, 'hidden_layers_sizes': [100]}  # 0.57
